...
func TestTwoStageL3ClosResourceStrings(t *testing.T) {
	...
	testData := []stringTestData{
		...
		{stringVal: "access_loopback_ips_ipv6", intType: ResourceGroupNameAccessIp6, stringType: resourceGroupNameAccessIp6},
		...
		{stringVal: "ipv6_access_l3_peer_link_link_ips", intType: ResourceGroupNameAccessAccessIp6, stringType: resourceGroupNameAccessAccessIp6},
