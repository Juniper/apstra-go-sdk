...
const (
	...
	apiUrlFfAggLinkById = apiUrlFfLinks + apiUrlPathDelim + "%s"
)
...
//	Label          string
//	Role           string
//	EndpointGroups [2][]FreeformEndpointGroup
//	Tags           []string
//	Endpoints      []FreeformAggregateEndpoint
//	MemberLinkIds  []ObjectId
//}
...
func (o *FreeformClient) UpdateAggregateLink(ctx context.Context, id ObjectId, in *FreeformLinkRequest) error {
