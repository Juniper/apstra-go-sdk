...
func (o *Client) GetAllTelemetryServiceRegistryEntries(ctx context.Context) ([]TelemetryServiceRegistryEntry, error) {
	var entries []TelemetryServiceRegistryEntry
	rawentries, err := o.getAllTelemetryServiceRegistryEntries(ctx)
	if err != nil {
		return entries, err
	}
	for _, rawe := range rawentries {
		e, err := rawe.polish()
		if err != nil {
			return entries, err
		}
...
// GetAllTelemetryServiceRegistryEntry gets a Telemetry Service Registry Entry identified by name
func (o *Client) GetTelemetryServiceRegistryEntry(ctx context.Context, name string) (*TelemetryServiceRegistryEntry, error) {
	rawe, err := o.getTelemetryServiceRegistryEntry(ctx, name)
	if err != nil {
		return nil, err
	}
	e, err := rawe.polish()
...
func (o *Client) CreateTelemetryServiceRegistryEntry(ctx context.Context, r TelemetryServiceRegistryEntry) (string, error) {
	name, err := o.createTelemetryServiceRegistryEntry(ctx, *r.raw())
	if err != nil {
		return "", err
	}
	return name, nil
...
func (o *Client) UpdateTelemetryServiceRegistryEntry(ctx context.Context, name string, r *TelemetryServiceRegistryEntry) error {
	return o.updateTelemetryServiceRegistryEntry(ctx, name, r.raw())
}

func (o *Client) DeleteTelemetryServiceRegistryEntry(ctx context.Context, name string) error {
	return o.deleteTelemetryServiceRegistryEntry(ctx, name)
}
