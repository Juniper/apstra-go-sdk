...
func (o StreamTarget) Start() (msgChan <-chan *aosStreaming.AosMessage, errChan <-chan error, err error) {
	var nl net.Listener
...
func (o StreamTarget) handleClientConn(conn net.Conn, msgChan chan<- *aosStreaming.AosMessage, errChan chan<- error) {
