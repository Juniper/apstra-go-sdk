...
func TestConfiglet_timestamps(t *testing.T) {
	testCases := map[string]Configlet{
		"a": {
...
func TestConfiglet_UnmarshalJSON(t *testing.T) {
	...
	testCases := map[string]testCase{
		"flow_data": {
			v: configletTestFlowDataJSON,
			e: configletTestFlowData,
		},
	}
