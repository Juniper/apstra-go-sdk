...
func TemplateL3Collapsed(t testing.TB, req, resp design.TemplateL3Collapsed, msg ...string) {
	msg = testmessage.Add(msg, "Comparing L3 Collapsed Template")
	...
	require.Equal(t, req.MeshLinkCount, resp.MeshLinkCount, msg)
	require.Equal(t, req.MeshLinkSpeed, resp.MeshLinkSpeed, msg)
